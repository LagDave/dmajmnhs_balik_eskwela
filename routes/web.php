...
Route::get('/invalidMachine', 'DataController@invalidMachine')->name('data.invalidMachine');
Route::get('/setup', 'DataController@setupPage')->name('data.setupPage');
Route::post('/setup/validate', 'DataController@setupValidate')->name('data.setupValidate');
Route::get('/invalidate', 'DataController@invalidateMachine')->name('data.invalidateMachine');
